...
const CommunicationPageFormComponent = ({ usersData }) => {
  console.log(usersData);
  const form = useForm({
    defaultValues: {
      1: usersData?.info[1][0],
      2: usersData?.info[2][0],
      3: usersData?.info[3][0],
      4: usersData?.info[4][0],
      5: usersData?.info[5][0],
      6: usersData?.info[6][0],
      7: usersData?.info[7][0],
      8: usersData?.info[8][0],
    },
  });
      ...
      <form onSubmit={handleSubmit(submitFormHandler)} noValidate>
        <div className="row mb-1 max-h-[calc(100vh-280px)] overflow-auto">
          <div className="col-xl-4">
            ...
            <div className="mb-3">
              <label htmlFor="alternative" className="form-label">
                GSM numaranız
              </label>
              <div className="position-relative">
                ...
                <input
                  ...
                  id="1"
                  placeholder="0554 312 49 17"
                />
              </div>
            </div>
            <div className="mb-3">
              <label htmlFor="alternative" className="form-label">
                Alternatif İletişim Numaranız
              </label>
              <div className="position-relative">
                <span className="absolute top-2 left-2">
                  <svg
            ...
            <h4
              ...
              className="text-banabi mb-3 mt-5"
            >
            ...
            <div className="mb-3">
              <div className="position-relative">
                ...
                <input
                  ...
                  className="border rounded-md px-2 py-2  w-full ps-5 placeholder-[#d6d6d6]  placeholder:text-sm"
                  id="instagram"
                  placeholder="Instagram Linkiniz"
                />
              </div>
            </div>
          </div>
...
export default CommunicationPageFormComponent;
